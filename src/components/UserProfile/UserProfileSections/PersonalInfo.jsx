...
const PersonalInfo = () => {
    ...
    const { user, isAuthenticateds } = state; // Извлекаем пользователя из состояния
    ...
    //Данный блок можно использовать везде, где увидим, что данные пользователя почему-то не убираются, хотя должны.
    // useEffect(() => {
    //     const token = localStorage.getItem('authToken');
    //     if (!token) {
    //         // Очищаем состояние пользователя при отсутствии токена
