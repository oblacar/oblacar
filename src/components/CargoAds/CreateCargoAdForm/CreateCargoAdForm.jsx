...
const CreateCargoAdForm = ({
    ...
    AddPhotoButton = AddPhotoCargo, // опц.
    MultiPhotoUploader = MultiTruckPhotoUploader, // опц. (можно твой MultiTruckPhotoUploader)
            ...
            >
                ...
                <section className='accf__card'>
                    ...
                    <div className='accf__field'>
                        ...
                        />
                        {errors.pickupDate && (
                            <p className='accf__error'>{errors.pickupDate}</p>
                        )}
                    </div>
                ...
                <section className='accf__card'>
                    ...
                    <div className='accf__field'>
                        ...
                        />
                        {errors.title && (
                            <p className='accf__error'>{errors.title}</p>
                        )}
                    </div>
                    ...
                    <div className='accf__field'>
                        ...
                        {errors.cargoType && (
                            <p className='accf__error'>{errors.cargoType}</p>
                        )}
                    </div>
                    ...
                    {MultiPhotoUploader && (
                        <MultiPhotoUploader
                            ...
                            updateFormData={({ truckPhotoUrls }) => {
                                const photos = Array.isArray(truckPhotoUrls)
                                    ? truckPhotoUrls
                                    : [];
                    ...
                    <div className='accf__field'>
                        ...
                        />
                        {errors.weightTons && (
                            <p className='accf__error'>{errors.weightTons}</p>
                        )}
                    </div>
                    ...
                    <div className='accf__row accf__row--wrap'>
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                updateFormData({ adrClass: e.target.value })
                            }
